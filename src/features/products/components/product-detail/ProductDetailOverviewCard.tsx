  ...
  return (
    <article className="overflow-hidden rounded-3xl border border-slate-200 bg-white">
      ...
      <div className="space-y-4 p-5">
        <div>
          <h2 className="text-sm font-bold uppercase tracking-[0.5px] text-slate-500">Thong tin chung</h2>
        ...
        <div>
          <h2 className="text-sm font-bold uppercase tracking-[0.5px] text-slate-500">Gia ban</h2>
          <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-3">
              <p className="text-xs text-slate-500">Khoang gia</p>
              <p className="mt-1 text-base font-bold text-slate-900">{money(stats.minPrice)} - {money(stats.maxPrice)}</p>
            </div>
            <div className="rounded-xl border border-slate-200 bg-white p-3">
              <p className="text-xs text-slate-500">Gia trung binh</p>
        ...
        <div>
          <h2 className="text-sm font-bold uppercase tracking-[0.5px] text-slate-500">Kenh phan phoi</h2>
          <div className="mt-2 flex flex-wrap gap-2">
            {channels.length > 0 ? (
              ...
              <span className="text-sm text-slate-500">Chua co mapping kenh</span>
            )}
          </div>
        </div>
      </div>
