...
import type { RevenueChartsDailyTrendPointViewModel } from '@/features/dashboard/logic/dashboardRevenueCharts.types'
...
export function RevenueDailyTrendChart({ title, points }: RevenueDailyTrendChartProps) {
  return (
      ...
      <div className="h-[320px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={points} margin={{ top: 8, right: 8, left: 8, bottom: 4 }}>
            ...
            <Line type="monotone" dataKey="shopee" name="Shopee" stroke="#EE4D2D" strokeWidth={2.5} dot={false} />
            <Line type="monotone" dataKey="lazada" name="Lazada" stroke="#6366F1" strokeWidth={2.5} dot={false} />
            <Line type="monotone" dataKey="tiktokShop" name="TikTok Shop" stroke="#3525CD" strokeWidth={2.5} dot={false} />
