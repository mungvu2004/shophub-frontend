    ...
    <section className="rounded-3xl border border-slate-100 bg-white p-6 shadow-sm">
      <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-4 text-xs font-semibold text-slate-600">
          <span className="inline-flex items-center gap-1.5"><span className="size-2 rounded-full bg-[#f97316]" />Shopee</span>
          <span className="inline-flex items-center gap-1.5"><span className="size-2 rounded-full bg-[#1d4ed8]" />TikTok Shop</span>
          <span className="inline-flex items-center gap-1.5"><span className="size-2 rounded-full bg-[#8b5cf6]" />Lazada</span>
      ...
      <div className="h-80 rounded-2xl border border-slate-100 bg-gradient-to-b from-slate-50 to-white px-3 py-2">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={dailyRevenue} margin={{ top: 12, right: 8, bottom: 0, left: 0 }}>
            ...
            <Area type="monotone" dataKey="shopee" name="Shopee" stackId="1" stroke="#f97316" fill="url(#shopeeGradient)" strokeWidth={2.2} />
            <Area type="monotone" dataKey="tiktok" name="TikTok Shop" stackId="1" stroke="#2563eb" fill="url(#tiktokGradient)" strokeWidth={2.2} />
            <Area type="monotone" dataKey="lazada" name="Lazada" stackId="1" stroke="#8b5cf6" fill="url(#lazadaGradient)" strokeWidth={2.2} />
            <Area
              type="monotone"
              dataKey="previous"
