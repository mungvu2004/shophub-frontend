...
export function OrdersPendingActionsHeader({ title, description, isRefreshing }: OrdersPendingActionsHeaderProps) {
  return (
    <header className="space-y-2 rounded-xl border border-indigo-100 bg-gradient-to-r from-white to-indigo-50/45 px-4 py-3 shadow-[0_8px_20px_rgba(15,23,42,0.04)]">
