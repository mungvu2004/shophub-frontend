...
const recommendationSeeds = [
  ...
  },
  {
    id: 'rec-003',
    productId: 'prod-024',
    productName: 'Túi xách da mini',
    sku: 'BG-LTH-BRW',
    platform: 'lazada' as const,
    currentPrice: 450000,
    aiPrice: 435000,
    changePercent: -3.3,
    reason: 'Flash sale đối thủ',
    confidence: 2,
    imageLabel: 'BG',
    imageColor: '#0ea5e9',
  },
  {
    id: 'rec-004',
    productId: 'prod-029',
    productName: 'Áo khoác denim oversize',
    sku: 'JK-DEN-XL',
    platform: 'lazada' as const,
    currentPrice: 670000,
    aiPrice: 639000,
    changePercent: -4.6,
    reason: 'Cạnh tranh giá mua lẻ',
    confidence: 4,
    imageLabel: 'JK',
    imageColor: '#475569',
  },
  {
    id: 'rec-005',
    productId: 'prod-031',
    productName: 'Váy midi công sở',
    sku: 'DR-MID-M',
    platform: 'shopee' as const,
    currentPrice: 520000,
    aiPrice: 538000,
    changePercent: 3.5,
    reason: 'Doanh số 7 ngày tăng',
    confidence: 4,
    imageLabel: 'DR',
    imageColor: '#16a34a',
  },
...
export const productsDynamicPricingMock: DynamicPricingPayload = {
  ...
  rules: [
    {
      id: 'rule-1',
      title: 'Thấp hơn đối thủ 5%',
      description: 'Áp dụng: 234 sản phẩm',
      icon: 'trend',
      appliedProducts: 234,
    ...
    {
      id: 'rule-2',
      title: 'Tối thiểu lợi nhuận 20%',
      description: 'Bảo vệ biên lợi nhuận',
      icon: 'shield',
      appliedProducts: 234,
      platforms: ['shopee', 'tiktok_shop', 'lazada'],
      tag: 'Bảo vệ biên lợi nhuận',
      isActive: true,
      status: 'active',
    },
    {
      id: 'rule-3',
      title: 'Khuyến mãi cuối tuần -10%',
      description: 'T7, CN',
      icon: 'calendar',
      appliedProducts: 0,
      platforms: ['lazada'],
  ...
  insights: [
    {
      ...
      value: '+18.5%',
      description: 'Nếu áp dụng tất cả 47 gợi ý giá từ AI trong tuần này.',
    },
    {
      id: 'insight-2',
      tone: 'warning',
      title: 'Cảnh báo biên lợi nhuận',
      value: '12 sản phẩm',
      description: 'Đang có giá gần chạm mức tối thiểu 20% lợi nhuận.',
    },
    {
      id: 'insight-3',
      tone: 'success',
      ...
      value: 'Cao hơn 65%',
      description: 'Cửa hàng bạn đang có giá tốt nhất phân khúc áo thun.',
    },
  ],
}
