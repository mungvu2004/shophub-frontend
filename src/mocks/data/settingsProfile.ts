...
export const settingsProfileMock: SettingsProfileResponse = {
  ...
  identity: {
    ...
    jobTitle: 'Shop Owner / Admin',
    timezone: 'Asia/Ho_Chi_Minh',
    bio: 'Quản lý đa sàn: Shopee, Lazada, TikTok Shop. Tập trung vào SLA, doanh thu và hài lòng khách hàng.',
  ...
  securityChecks: [
    ...
    },
    {
      ...
      description: 'Email backup đã xác thực thành công.',
      status: 'healthy',
